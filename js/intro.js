...
if (powerLevel = 9000){
    ...
    console.log("Too powerful!!! >:O");

    document.getElementById("column1").innerHTML = '<img class="img-fluid" src="https://pbs.twimg.com/media/FISAGtuUYAETvKa?format=jpg&name=large">';

}

if (powerLevel = 9000){

    console.log("meowing :3");

    document.getElementById("column2").innerHTML = '<img class="img-fluid" src="https://i.pinimg.com/736x/72/b1/48/72b148f1d671a4c96ebad8dc105eb4cd.jpg">';
