...
function buildFour(){
    ...
    jotaro++;
    document.getElementById('city').innerHTML="You have "+jotaro+" Jotaro's in your city...? How'd he get there?!";
    document.getElementById('cityGraphic').innerHTML+="<img src='images/Jotaro.jpg'>"
